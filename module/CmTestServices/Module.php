        ...
        if (!empty($routeMatch)){
            ...
            if (!empty($module[0]))
                if ($module[0] == 'melis-backoffice'){
                    ...
                    (new \CmTestServices\Listener\SavePropertiesListener())->attach($eventManager);
                    (new \CmTestServices\Listener\DeleteListener())->attach($eventManager);
                }
        }
    }
