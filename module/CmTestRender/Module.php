        ...
        if (!empty($routeMatch)){
            ...
            if (!empty($module[0]))
                if ($module[0] == 'melis-backoffice'){
                    ...
                    (new \CmTestRender\Listener\SavePropertiesListener())->attach($eventManager);
                    (new \CmTestRender\Listener\DeleteListener())->attach($eventManager);
                }
        }
    }
