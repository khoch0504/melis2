...
namespace CmTestRender\Controller\Plugin;
 ...
 * $plugin = $this->MySiteTestTestpluginPlugin();
 * $pluginView = $plugin->render();
 *
 * How to call this plugin with custom parameters:
 * $plugin = $this->MySiteTestTestpluginPlugin();
 * $parameters = array(
 *      'template_path' => 'MySiteTest/testplugin'
 * );
 * $pluginView = $plugin->render($parameters);
 *
 * How to add to your controller's view:
 * $view->addChild($pluginView, 'testplugin');
 *
 * How to display in your controller's view:
 * echo $this->testplugin;
 */
class CmTestRenderPlugin extends MelisTemplatingPlugin
{
    ...
    public function __construct($updatesPluginConfig = array())
    {
        ...
        $this->pluginXmlDbKey = 'CmTestRenderPlugin';
    ...
    public function loadDbXmlToPluginConfig()
    {
        ...
        if ($xml) {          
			...
			if (!empty($xml->title))
				$configValues['title'] = (string)$xml->title;
			if (!empty($xml->date_create))
				$configValues['date_create'] = (string)$xml->date_create;
    ...
    public function savePluginConfigToXml($parameters)
    {
		...
		if (!empty($parameters['title']))
			 $xmlValueFormatted .= "\t\t". '<title><![CDATA[' . $parameters['title'] . ']]></title>';
		if (!empty($parameters['date_create']))
			 $xmlValueFormatted .= "\t\t". '<date_create><![CDATA[' . $parameters['date_create'] . ']]></date_create>';
